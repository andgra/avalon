...
$APPLICATION->IncludeComponent(
	...
	array(
		'ID' => 'COURSE_LIST',
		'ACTIVE_ITEM_ID' => 'STRUCTURE.COURSE',
...
$APPLICATION->IncludeComponent(
	'newportal:order.course.menu',
	'',
	array(
		'PATH_TO_COURSE_LIST' => $arResult['PATH_TO_COURSE_LIST'],
		'PATH_TO_COURSE_EDIT' => $arResult['PATH_TO_COURSE_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['course_id'],
		'TYPE' => 'list'
	),
	$component
);?>
