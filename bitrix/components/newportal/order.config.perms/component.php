...
if(COrderPerms::IsAdmin() && COption::GetOptionString('order', '~ORDER_REBUILD_COMPANY_ATTR', 'N') === 'Y')
{
	$arResult['NEED_FOR_REBUILD_COMPANY_ATTRS'] = true;
}

$arResult['NEED_FOR_REBUILD_CONTACT_ATTRS'] = false;
if(COrderPerms::IsAdmin() && COption::GetOptionString('order', '~ORDER_REBUILD_CONTACT_ATTR', 'N') === 'Y')
{
	$arResult['NEED_FOR_REBUILD_CONTACT_ATTRS'] = true;
}

$arResult['NEED_FOR_REBUILD_DEAL_ATTRS'] = false;
if(COrderPerms::IsAdmin() && COption::GetOptionString('order', '~ORDER_REBUILD_DEAL_ATTR', 'N') === 'Y')
{
	$arResult['NEED_FOR_REBUILD_DEAL_ATTRS'] = true;
}

$arResult['NEED_FOR_REBUILD_LEAD_ATTRS'] = false;
if(COrderPerms::IsAdmin() && COption::GetOptionString('order', '~ORDER_REBUILD_LEAD_ATTR', 'N') === 'Y')
{
	$arResult['NEED_FOR_REBUILD_LEAD_ATTRS'] = true;
}

$arResult['NEED_FOR_REBUILD_QUOTE_ATTRS'] = false;
if(COrderPerms::IsAdmin() && COption::GetOptionString('order', '~ORDER_REBUILD_QUOTE_ATTR', 'N') === 'Y')
{
	$arResult['NEED_FOR_REBUILD_QUOTE_ATTRS'] = true;
}

$arResult['NEED_FOR_REBUILD_INVOICE_ATTRS'] = false;
if(COrderPerms::IsAdmin() && COption::GetOptionString('order', '~ORDER_REBUILD_INVOICE_ATTR', 'N') === 'Y')
{
