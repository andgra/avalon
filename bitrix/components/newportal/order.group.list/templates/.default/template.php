...
?>
    <script type="text/javascript">
        function order_group_delete_grid(title, message, btnTitle, path)
        {
            var d;
            d = new BX.CDialog({
                title: title,
...
$arData=array();
foreach($arResult['GROUP'] as $id => $el) {
    $data=array(
        'id' => $id,
        'actions' => array(
            array(
                'ICONCLASS' => 'edit',
                'TITLE' => GetMessage('ORDER_GROUP_EDIT_TITLE'),
                'TEXT' => GetMessage('ORDER_GROUP_EDIT'),
                'ONCLICK' => 'jsUtils.Redirect([], \''.$el['PATH_TO_GROUP_EDIT'].'\');',
                'DEFAULT' => true,
            ),
            /*array(
                'ICONCLASS' => 'delete',
                'TITLE' => GetMessage('ORDER_GROUP_DELETE_TITLE'),
                'TEXT' => GetMessage('ORDER_GROUP_DELETE'),
                'ONCLICK' => "order_group_delete_grid('".CUtil::JSEscape(GetMessage('ORDER_GROUP_DELETE_TITLE'))."', '".CUtil::JSEscape(GetMessage('ORDER_GROUP_DELETE_CONFIRM'))."', '".CUtil::JSEscape(GetMessage('ORDER_GROUP_DELETE'))."', '".CUtil::JSEscape($el['PATH_TO_GROUP_DELETE'])."')"
            )*/
        ),
        'data' => $el,
        'editable' => false
    ...
    $row=array(
        'ID' => '<a href="'.$el['PATH_TO_GROUP_EDIT'].'">'.$el['ID'].'</a>',
        'TITLE' => '<a href="'.$el['PATH_TO_GROUP_EDIT'].'">'.$el['TITLE'].'</a>',
