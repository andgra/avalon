...
$APPLICATION->IncludeComponent(
	'newportal:order.agent.menu',
	'', 
	array(
		'PATH_TO_AGENT_LIST' => $arResult['PATH_TO_AGENT_LIST'],
		'PATH_TO_AGENT_EDIT' => $arResult['PATH_TO_AGENT_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['agent_id'],
		'TYPE' => 'list'
	),
	$component
);?>
