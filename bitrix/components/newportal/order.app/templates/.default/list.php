...
$APPLICATION->IncludeComponent(
	'newportal:order.app.menu',
	'',
	array(
		'PATH_TO_APP_LIST' => $arResult['PATH_TO_APP_LIST'],
		'PATH_TO_APP_EDIT' => $arResult['PATH_TO_APP_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['app_id'],
		'TYPE' => 'list'
	),
	$component
);?>
