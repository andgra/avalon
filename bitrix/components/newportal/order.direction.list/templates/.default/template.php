...
?>
    <script type="text/javascript">
        function order_direction_delete_grid(title, message, btnTitle, path)
        {
            var d;
            d = new BX.CDialog({
                title: title,
...
$arData=array();
foreach($arResult['DIRECTION'] as $id => $el) {
    $data=array(
        'id' => $id,
        'actions' => array(
            array(
                'ICONCLASS' => 'edit',
                'TITLE' => GetMessage('ORDER_DIRECTION_EDIT_TITLE'),
                'TEXT' => GetMessage('ORDER_DIRECTION_EDIT'),
                'ONCLICK' => 'jsUtils.Redirect([], \''.$el['PATH_TO_DIRECTION_EDIT'].'\');',
                'DEFAULT' => true,
            ),
            /*array(
                'ICONCLASS' => 'delete',
                'TITLE' => GetMessage('ORDER_DIRECTION_DELETE_TITLE'),
                'TEXT' => GetMessage('ORDER_DIRECTION_DELETE'),
                'ONCLICK' => "order_direction_delete_grid('".CUtil::JSEscape(GetMessage('ORDER_DIRECTION_DELETE_TITLE'))."', '".CUtil::JSEscape(GetMessage('ORDER_DIRECTION_DELETE_CONFIRM'))."', '".CUtil::JSEscape(GetMessage('ORDER_DIRECTION_DELETE'))."', '".CUtil::JSEscape($el['PATH_TO_DIRECTION_DELETE'])."')"
            )*/
        ),
        'data' => $el,
        'editable' => false
