...
$APPLICATION->IncludeComponent(
	...
	array(
		'ID' => 'PHYSICAL_LIST',
		'ACTIVE_ITEM_ID' => 'PERSON.PHYSICAL',
...
$APPLICATION->IncludeComponent(
	'newportal:order.physical.menu',
	'',
	array(
		'PATH_TO_PHYSICAL_LIST' => $arResult['PATH_TO_PHYSICAL_LIST'],
		'PATH_TO_PHYSICAL_EDIT' => $arResult['PATH_TO_PHYSICAL_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['physical_id'],
		'TYPE' => 'list'
	),
	$component
);?>
