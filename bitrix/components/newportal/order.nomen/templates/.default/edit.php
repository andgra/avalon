...
$APPLICATION->IncludeComponent(
	...
	array(
		'ID' => 'NOMEN_EDIT',
		'ACTIVE_ITEM_ID' => 'STRUCTURE.NOMEN',
...
$APPLICATION->IncludeComponent(
	'newportal:order.nomen.menu',
	'',
	array(
		'PATH_TO_NOMEN_LIST' => $arResult['PATH_TO_NOMEN_LIST'],
		'PATH_TO_NOMEN_EDIT' => $arResult['PATH_TO_NOMEN_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['nomen_id'],
		'TYPE' => 'edit'
	),
	$component
);?>
...
<?$APPLICATION->IncludeComponent(
	'newportal:order.nomen.edit',
	'', 
	array(
		'PATH_TO_NOMEN_LIST' => $arResult['PATH_TO_NOMEN_LIST'],
		'PATH_TO_NOMEN_EDIT' => $arResult['PATH_TO_NOMEN_EDIT'],
		'PATH_TO_DIRECTION_SHOW' => $arResult['PATH_TO_DIRECTION_SHOW'],
