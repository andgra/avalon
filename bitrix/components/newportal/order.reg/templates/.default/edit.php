...
$APPLICATION->IncludeComponent(
	'newportal:order.reg.menu',
	'',
	array(
		'PATH_TO_REG_LIST' => $arResult['PATH_TO_REG_LIST'],
		'PATH_TO_REG_EDIT' => $arResult['PATH_TO_REG_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['reg_id'],
		'TYPE' => 'edit'
	),
	$component
);?>
