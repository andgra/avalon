...
$APPLICATION->IncludeComponent(
	...
	'',
	array(
		'ID' => 'FORMED_GROUP_LIST',
		'ACTIVE_ITEM_ID' => 'STRUCTURE.FORMED_GROUP',
...
$APPLICATION->IncludeComponent(
	'newportal:order.formed_group.menu',
	'',
	array(
		'PATH_TO_FORMED_GROUP_LIST' => $arResult['PATH_TO_FORMED_GROUP_LIST'],
		'PATH_TO_FORMED_GROUP_EDIT' => $arResult['PATH_TO_FORMED_GROUP_EDIT'],
		'ELEMENT_ID' => $arResult['VARIABLES']['formed_group_id'],
		'TYPE' => 'list'
	),
	$component
);?>
...
<?
$APPLICATION->IncludeComponent(
	'newportal:order.formed_group.list',
	'',
	array(
		'FORMED_GROUP_COUNT' => '20',
		'PATH_TO_NOMEN_EDIT' => $arResult['PATH_TO_NOMEN_EDIT'],
