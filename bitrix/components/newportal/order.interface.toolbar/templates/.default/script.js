if(typeof(BX.InterfaceToolBar) === "undefined")
{
	...
	BX.InterfaceToolBar.prototype =
	{
		initialize: function(id, settings)
		{
			...
			if(container)
			{
				var btnClassName = this.getSetting("moreButtonClassName", "order-setting-btn");
		...
		_onMenuClose: function()
		{
			...
			BX.onCustomEvent(window, "OrderInterfaceToolbarMenuClose", [ this, eventArgs]);
		},
		_onMoreButtonClick: function(e)
		{
			...
			BX.onCustomEvent(window, "OrderInterfaceToolbarMenuShow", [ this, eventArgs]);
